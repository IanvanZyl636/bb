...
export interface PageFixtures {
  ...
  achPositivePayPage: AchPositivePayPage;
  allContactsPage: AllContactsPage;
  allPayeesPage: AllPayeesPage;
  auditPage: AuditPage;
  basePage: BasePage;
  cardsPage: CardsPage;
  checkPositivePayPage: CheckPositivePayPage;
...
export const pageFixtures = {
  ...
  achPositivePayPage: async ({ page }: CommonFixtures, use: UseFunction) => {
    await use(new AchPositivePayPage(page));
  },
  ...
  checkPositivePayPage: async ({ page }: CommonFixtures, use: UseFunction) => {
    await use(new CheckPositivePayPage(page));
  },
